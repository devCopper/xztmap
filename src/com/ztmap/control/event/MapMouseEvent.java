...
public final class MapMouseEvent {
	 ...
	 *            the mouse event.
	 * @param isWheel
	 *            if <code>true</code> then the event comes from the mouse
	 *            wheel.
	 */
	public MapMouseEvent(MapControl pane, MouseEvent event, boolean isWheel) {
		this.event = event;
	 ...
	 * the second button, and 3 for the third button, etc. On mouse dragging
