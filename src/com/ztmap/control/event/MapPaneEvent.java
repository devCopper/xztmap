...
/**
 * An event class used by {@code SwtMapPane} to signal changes of state to
 * listeners.
 *
 * 
...
public class MapPaneEvent extends EventObject {
	 ...
	 *            the type of event.
	 */
	public MapPaneEvent(MapControl source, Type type) {
		super(source);
		this.type = type;
	}
	 ...
	 *            the event data.
	 */
	public MapPaneEvent(MapControl source, Type type, Object data) {
		super(source);
		this.type = type;
		this.data = data;
	}
