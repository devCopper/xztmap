...
package com.ztmap.control.event;

/**
 * An adapter class that implements all of the method defined in the
 * {@code MapPaneListener} interface as empty methods, allowing sub-classes to
 * just override the methods they need.
 *
...
public class MapPaneAdapter implements MapPaneListener {
	...
	/**
	 * Called by the map pane when its display area has been changed e.g. by
	 * zooming or panning
	 *
	 * @param ev
	 *            the event
	...
	/**
	 * Called by the map pane when it is rendering features. The event will be
	 * carrying data: a floating point value between 0 and 1 indicating
	 * rendering progress.
	 *
	 * @param ev
	 *            the event
