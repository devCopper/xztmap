...
/**
 * Receives mouse events from a {@link MapControl} instance, converts them to
 ...
 * @source $URL$
 */
public class ToolManager implements MouseListener, MouseMoveListener, MouseWheelListener, MouseTrackListener {
	 ...
	 * 
	 * @param pane
	 *            the map pane that owns this listener
	 */
	public ToolManager(MapControl pane) {
		this.mapControl = pane;
	}
	...
	public boolean setCursorTool(CursorTool tool) {
		...
		cursorTool = tool;
		cursorTool.setMapControl(mapControl);
	...
	private MapMouseEvent convertEvent(MouseEvent e) {
		...
		if (mapControl.getScreenToWorldTransform() != null) {
			ev = new MapMouseEvent(mapControl, e, false);
		}
	...
	private MapMouseEvent convertWheelEvent(MouseEvent e) {
		MapMouseEvent ev = null;
		if (mapControl.getScreenToWorldTransform() != null) {
			ev = new MapMouseEvent(mapControl, e, true);
		}
