...
public abstract class ZoomTool extends CursorTool {
	 ...
	 *            button
	 */
	public ZoomTool(int triggerButtonMask) {
		super(triggerButtonMask);
		setZoom(DEFAULT_ZOOM_FACTOR);
	}

	/**
	 * Constructs a new abstract zoom tool which is triggered by any mouse
	 * button.
	 */
	public ZoomTool() {
